  ...
  "data": getPeopleSector(data)
        ...
        function deferAjaxCall() {
            return dtModel.IsDtAjaxLoadingDefferd;
        }
        function cancelDeferAjaxCall() {
            return dtModel.IsDtAjaxLoadingDefferd=false;
        }
